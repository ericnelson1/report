 ...
 .directive('treecontrol', ['$compile', function ($compile) {
     ...
     return {
         ...
         controller: ['$scope', function ($scope) {
             ...
             ensureDefault($scope.options, "nodeChildren", "folder");
             ...
             //var template =
             //   '<ul ' + classIfDefined($scope.options.injectClasses.ul, true) + '>' +
             //        '<li ng-repeat="node in folders.' + $scope.options.nodeChildren + ' | filter:filterExpression:filterComparator | orderBy:orderBy:reverseOrder" ng-class="headClass(node)" ' + classIfDefined($scope.options.injectClasses.li, true) + '>' +
             //        '<i class="tree-branch-head" ng-class="iBranchClass()" ng-click="selectNodeHead(node)"></i>' +
             //        '<i class="tree-leaf-head ' + classIfDefined($scope.options.injectClasses.iLeaf, false) + '"></i>' +
             //        '<div class="tree-label ' + classIfDefined($scope.options.injectClasses.label, false) + '" ng-class="selectedClass()" ng-click="selectNodeLabel(node)" tree-transclude></div>' +
             //        '<treeitem ng-if="nodeExpanded()"></treeitem>' +
